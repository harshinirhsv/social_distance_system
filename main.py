...
def mainc():
	...
	accuracy_plot_dir=base_dir+'/Models'
	model_store_dir=base_dir+'/Models/mask_detector.model'
	...
	while True:
		...
		cv2.putText(frame, "SOCIAL DISTANCE AND FACE MASK DETECTION", (140, 45),
					cv2.FONT_HERSHEY_SIMPLEX, 1, (222, 49, 99), 2)
		...
		for (box, pred) in zip(locs, preds):
			...
			label = "Mask" if mask > withoutMask else "No Mask,WEAR MASK"
