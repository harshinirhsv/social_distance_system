...
cv2.namedWindow('Social distancing analyser', cv2.WINDOW_NORMAL)
...
while True:
    ...
    if len(idxs) > 0:
        ...
        for i in idf:
            ...
            cv2.putText(frame, "Social Distancing violation system", (210, 45),
        ...
        cv2.imshow('Social distancing analyser', frame)# Add this block to close the window when 'q' key is pressed
